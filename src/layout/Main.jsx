  ...
  return (
    <div className="h-screen bg-[#424242]">
      ...
      <div className="flex w-full h-full overflow-hidden">
             ...
             <div className="h-full overflow-y-auto scrollbar-none">
              ...
              <Link to="/content_creator">
                <div className="flex items-center px-2">
                  ...
                  <h1 className="flex text-sm items-center text-white px-4 py-1">
                    Content Creator
                  </h1>
                </div>
              </Link>
            ...
            <div className="row-span-4 w-full bg-[#1E1C1A] rounded-lg py-5 px-4">
              ...
              <div className="overflow-y-scroll max-h-[70%]  scrollbar-none scrollbar-thumb-gray-500 scrollbar-track-gray-800">
                <div className="flex flex-col gap-3">
                  <Link
                    to="/cook_books"
                    className="text-white bg-[#272727] px-4 rounded-lg drop-shadow-lg flex items-center justify-center"
                  >
                    favorites
                  </Link>
                  <Link
            ...
            <div className="row-span-5 w-full bg-[#1E1C1A] rounded-lg py-5 px-4">
              ...
              <div className="overflow-y-auto max-h-[80%] scrollbar-none scrollbar-thumb-gray-500 scrollbar-track-gray-800">
                <div className="flex flex-col gap-3">
                  <button
                    type="button"
                    className="text-white bg-[#272727] px-4 rounded-lg"
                  >
                    Chef-1
                  </button>
                  <button
        ...
        {/* Content */}
        <div className="w-full h-full pr-3 py-3 rounded-lg bg-[#424242]">
          <Outlet />
        </div>
      </div>
    </div>
