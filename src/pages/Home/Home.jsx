  ...
  return (
    <div className="w-full h-full rounded-lg">
      <div className="h-full grid grid-row-10 rounded-lg bg-[#1E1C1A]">
        ...
        >
          {/* Top 10 Section */}
          <div className="row-span-1 flex flex-col items-start  mb-4">
            <h2 className="text-[30.67px] font-bold text-white">Top 10</h2>
            <div className="grid grid-cols-2 overflow-y-auto md:max-h-[40%] lg:max-h-[80%] sm:grid-cols-2  md:grid-cols-3 lg:grid-cols-5 gap-5 lg:gap-16  mt-4">
