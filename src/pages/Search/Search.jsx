    ...
    return (
      ...
      <div className="w-full h-full p-10 bg-[#272727]">
          <div className="relative w-full h-[209px] rounded-lg bg-gradient-to-b from-[#768895] mb-8">
            <h1 className="absolute bottom-[20%] left-[5%] text-[42.67px] font-bold text-white">Search </h1>
          </div>
          ...
          <div className="mb-8">
            ...
            <div className="flex gap-10  mt-4">
              ...
              <img src={top10Img4} alt="Image 4" className="w-[133px] h-[128px] mr-4" />
              <img src={top10Img5} alt="Image 4" className="w-[133px] h-[128px]" />
            </div>
          </div>
          ...
          <div className="mt-[160px]">
            ...
            <div className="flex gap-10 mt-4">
              ...
              <img src={lastSearch4} alt="Image 8" className="w-[133px] h-[128px] mr-4" />
              <img src={top10Img5} alt="Image 4" className="w-[133px] h-[128px]" />
            </div>
          </div>
          </div>
